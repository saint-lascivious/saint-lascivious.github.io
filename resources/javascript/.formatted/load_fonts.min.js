/**
 * sainternet.xyz - resources/javascript/load_fonts.min.js
 ...
 */
function loadFonts() {
  window.console && console.log("[Font Loader] Loading fonts");
  try {
    if (sessionStorage.fontsLoaded) {
      window.console && console.log("[Font Loader] Skipping - Fonts already loaded");
    ...
    if ('fonts' in document) {
      Promise.all([
        ...
        window.console && console.log("[Font Loader] Fonts loaded");
        document.documentElement.classList.add('fonts-loaded');
        sessionStorage.fontsLoaded = true;
      });
    }
  } catch (error) {
    window.console && console.error('[Font Loader] Error loading fonts: ', error);
  }
}
