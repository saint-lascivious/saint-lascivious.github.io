 ...
 * Announce ourselves.
 */
consoleWrapper(`[Load Fonts] Loaded`);

/**
 * Loads Roboto font if not already loaded and adds a 'fonts-loaded' class to the document.
 * @function
 * @name loadFonts
 * @returns {void}
 */
function loadFonts() {
  if (sessionStorage.fontsLoaded) {
    consoleWrapper('[Load Fonts] Fonts already loaded');
  ...
  if ('fonts' in document) {
    Promise.all([
      ...
      consoleWrapper('[Load Fonts] Fonts loaded');
      document.documentElement.classList.add('fonts-loaded');
