...
/**
 * Toggles the CONSOLE_LOGGING flag in local storage.
 *
 * @function
...
function toggleConsoleLogging() {
  ...
  if (consoleFlag === 'true') {
    consoleWrapper('[Debug] CONSOLE_LOGGING: false');
    consoleValue = false;
    sessionStorage.setItem('CONSOLE_LOGGING', 'false');
  } else {
    consoleValue = true;
    sessionStorage.setItem('CONSOLE_LOGGING', 'true');
    consoleWrapper('[Debug] CONSOLE_LOGGING: true');
  }
