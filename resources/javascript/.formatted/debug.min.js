...
/**
 * Sends a "forceupdate" message to the service worker.
 *
 * @name forceServiceWorkerCacheUpdate
 * @function
 * @return {void}
 */
function forceServiceWorkerCacheUpdate() {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.ready
      .then((registration) => {
        consoleWrapperSimple('[Debug] Sending service worker forceupdate message');
