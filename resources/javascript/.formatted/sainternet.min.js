...
function closeDrawer() {
  window.console && console.log("[Event Listener] Action: toggle drawer");
...
const el = document.querySelector('.mdl-layout__drawer');

if (el) {
  window.console && console.log("[Event Listener] Event: click");
