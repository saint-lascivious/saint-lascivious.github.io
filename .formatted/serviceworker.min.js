 ...
 * date and time in the log message.
 */
function consoleWrapperSimple(message, logType = 'log', includeDateTime = false) {
  if (includeDateTime) {
    message = `${new Date().toLocaleString()} - ${message}`;
  }
...
self.addEventListener('message', (event) => {
  if (event.data.type === 'debug') {
    ...
    consoleWrapperSimple('[Service Worker] Info:');
    ...
    consoleWrapperSimple(`[Service Worker] Full cache name: ${fullCacheName}`);
    consoleWrapperSimple(`[Service Worker] Manifest: ${baseDomain}/sainternet.webmanifest`);
