 ...
 * the SERVICEWORKER_LOGGING flag is set to true.
 *
...
function consoleWrapper(message, logType = 'log', includeDateTime = false) {
  ...
  if (self.SERVICEWORKER_LOGGING && typeof console === 'object' && typeof console[logType] === 'function') {
...
self.addEventListener('message', function(event) {
  if (event.data.type === 'serviceworker_logging') {
    const consoleValue = event.data.value;
    self.SERVICEWORKER_LOGGING = consoleValue;
