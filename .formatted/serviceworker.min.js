...
/**
 * Listens for messages sent from the client and updates the service worker's
 * debug flag accordingly.
 *
 * @function
...
/**
 * Listens for "ping" messages from the client and responds with a "pong" message.
 *
 * @function
 * @param {MessageEvent} event - The event object containing the message data.
 * @return {void}
