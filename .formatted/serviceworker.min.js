...
const jsCritical = [
  `${baseDomain}/resources/hammer.js/hammer.min.js`,
  `${baseDomain}/resources/javascript/console_wrapper.min.js`,
  `${baseDomain}/resources/javascript/debug.min.js`,
  `${baseDomain}/resources/javascript/gesture_handler.min.js`,
...
self.addEventListener('message', function(event) {
  if (event.data.type === 'debug') {
    ...
    consoleWrapperSimple(`[Service Worker] My strongest caches would kill you, Debug. You can't handle my strongest caches.`);
  }
});
