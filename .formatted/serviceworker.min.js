 ...
 */
const appName = 'sainternet';
const appProto = 'https://';
const appTld = '.xyz';
const appVersion = '1.1.0';
const versionPrefix = '_v';
const versionSuffix = '-stable';
const basePath = `${appProto}${appName}${appTld}`;
...
const googleFontPath = `${resourcePath}/google/webfonts`;
const iconPath = `${resourcePath}/icons`;
const imgPath = `${resourcePath}/images`;
const jsPath = `${resourcePath}/javascript`;
const cacheName = `${appName}${versionPrefix}${appVersion}${versionSuffix}`;
...
const cssUrls = [
  ...
  `${resourcePath}/google/css/materialicons.min.css`,
  `${resourcePath}/google/css/roboto.min.css`,
  `${resourcePath}/google/css/robotomono.min.css`,
...
const fontUrls = [
  ...
  `${googleFontPath}/materialicons/v140/Material-Icons.woff2`,
  `${googleFontPath}/robotomono/v22/RobotoMono-BoldItalic.woff2`,
  `${googleFontPath}/robotomono/v22/RobotoMono-Bold.woff2`,
  `${googleFontPath}/robotomono/v22/RobotoMono-Italic.woff2`,
  `${googleFontPath}/robotomono/v22/RobotoMono-Regular.woff2`,
  `${googleFontPath}/roboto/v30/Roboto-Black.woff2`,
  `${googleFontPath}/roboto/v30/Roboto-Bold.woff2`,
  `${googleFontPath}/roboto/v30/Roboto-Italic.woff2`,
  `${googleFontPath}/roboto/v30/Roboto-Medium.woff2`,
  `${googleFontPath}/roboto/v30/Roboto-Regular.woff2`,
];
...
self.addEventListener('activate', function(event) {
  consoleWrapper(`[Service Worker] Event: activate ${appName}`);
  try {
...
self.addEventListener('install', function(event) {
  consoleWrapper(`[Service Worker] Event: install ${appName}`);
  try {
    event.waitUntil(
...
self.addEventListener('message', function(event) {
  if (event.data.type === 'console_logging') {
    ...
    consoleWrapperSimple(`[Service Worker] Name: ${appName}`);
