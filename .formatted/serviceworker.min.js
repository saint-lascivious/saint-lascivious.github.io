...
self.addEventListener('message', (event) => {
  if (event.data.type === 'debug') {
    ...
    console.log(`[Service Worker] Name: ${cacheName}`);
    console.log(`[Service Worker] Cache name: ${fullCacheName}`);
    console.log(`[Service Worker] Domain: ${baseDomain}`);
