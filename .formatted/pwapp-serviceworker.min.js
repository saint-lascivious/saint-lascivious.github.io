    ...
    event.respondWith(
      caches.open(PWA_CACHE_NAME)
        .then(function (cache) {
          ...
          .catch(function (error) {
            // console.error("[Service Worker] Cache match failed");
          });
        })
      .catch(function (error) {
        // console.error("[Service Worker] Cache opening failed");
      })
    );
  } catch (error) {
...
self.addEventListener('install', function (event) {
  ...
  try {
    ...
    event.waitUntil(
      ...
      .catch(function (error) {
        // console.error("[Service Worker] Cache initiation failed");
      })
    );
  } catch (error) {
...
self.addEventListener('activate', function (event) {
  ...
  try {
    ...
    event.waitUntil(
      ...
      .catch(function (error) {
        // console.error("[Service Worker] Error deleting cache");
      })
    );
  } catch (error) {
