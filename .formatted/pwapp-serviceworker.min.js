...
const PWA_NAME = 'sainternet';
const PWA_VERSION = '_v0.3';

const PWA_CACHE_NAME = PWA_NAME + PWA_VERSION;
...
const CSS_URLS = [
  // 'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/css/brands.min.css',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/css/brands-stripped.min.css',
  // 'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/css/fontawesome.min.css',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/css/fontawesome-stripped.min.css',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/css/solid.min.css',
...
const FONT_URLS = [
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/webfonts/fa-brands-400.ttf',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/webfonts/fa-brands-400.woff2',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/webfonts/fa-solid-900.ttf',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/webfonts/fa-solid-900.woff2',
];
...
const JS_URLS = [
  ...
  'https://sainternet.xyz/resources/javascript/load_fonts.min.js',
  ...
  'https://sainternet.xyz/resources/javascript/tag_manager.min.js',
];

const LICENSE_URLS = [
  'https://sainternet.xyz/LICENSE',
  'https://sainternet.xyz/resources/fontawesome-free-6.3.0-web/LICENSE.txt',
];
...
self.addEventListener('fetch', function (event) {
  // "use strict";
  window.console && console.log('[Service Worker] Event: fetch');
  try {
    event.respondWith(
        ...
        .then(function (cache) {
          return cache.match(event.request)
            .then(function (response) {
              if (response) {
                return response;
                window.console && console.log('[Service Worker] Response');
              }
              return fetch(event.request)
                .then(function (networkResponse) {
                  if (!networkResponse || networkResponse.status !== 200 || networkResponse.type !== 'basic') {
                    return networkResponse;
                    window.console && console.log('[Service Worker] Network response');
                  }
                  cache.put(event.request, networkResponse.clone());
                  return networkResponse;
                  window.console && console.log('[Service Worker] Network response, added to cache');
                })
              .catch(function (error) {
                window.console && console.error("[Service Worker] Fetch failed:", error);
              });
            })
          .catch(function (error) {
            window.console && console.error("[Service Worker] Cache match failed:", error);
          });
        })
      .catch(function (error) {
        window.console && console.error("[Service Worker] Cache opening failed:", error);
      })
    );
  } catch (error) {
    window.console && console.error('[Service Worker] Error during fetch event: ', error);
  }
});

self.addEventListener('install', function (event) {
  // "use strict";
  window.console && console.log('[Service Worker] Event: install');
  try {
    self.skipWaiting();
    event.waitUntil(
      caches.open(PWA_CACHE_NAME)
        .then(function (cache) {
          ...
          window.console && console.log('[Service Worker] Cache init');
        })
      .catch(function (error) {
        window.console && console.error("[Service Worker] Cache initiation failed:", error);
      })
    );
  } catch (error) {
    window.console && console.error('[Service Worker] Error during install event: ', error);
  }
});

self.addEventListener('activate', function (event) {
  // "use strict";
  window.console && console.log('[Service Worker] Event: activate');
  try {
    if (self.clients && clients.claim) {
      window.console && console.log('[Service Worker] Claiming any available client(s)');
      clients.claim();
    }
    event.waitUntil(
      caches.keys()
        .then(function (cacheNames) {
          return Promise.all(
            cacheNames.filter(function (cacheName) {
              window.console && console.log('[Service Worker] Checking for orphaned caches');
              return cacheName.startsWith(PWA_NAME) && cacheName !== PWA_CACHE_NAME;
            }).map(function (cacheName) {
              window.console && console.log('[Service Worker] Deleting orphaned caches');
              return caches.delete(cacheName);
            })
          );
        })
      .catch(function (error) {
        window.console && console.error("[Service Worker] Error deleting cache:", error);
      })
    );
  } catch (error) {
    window.console && console.error('[Service Worker] Error during activate event: ', error);
  }
});
