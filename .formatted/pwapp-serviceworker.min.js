...
const PWA_VERSION = "version_02";
const PWA_CACHE_NAME = PWA_PREFIX + PWA_VERSION;
...
const ALL_URLS = CSS_URLS.concat(HTML_URLS, FONT_URLS, ICON_URLS, IMG_URLS, JS_URLS, PWA_URLS);
